Locales ['cs'] = { 
    ['usedoxygen'] = 'Nandal jsi si ~y~1x~s~ ~b~Kyslíkovou Masku~s~ a zapojil jsi ~b~kyslíkovou bombu~w~. Uroven kyslíku: ~g~100~w~',
    ['vyprazdnovani'] = 'Zbývá %s%s~w~ ~b~kyslíku~y~ v kyslíkové bombe',
